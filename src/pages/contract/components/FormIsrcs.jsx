...
const FormIsrcs = props => {
  ...
  const searchOption = (keyword, idx) => {
    ...
    clearTimeout(timer);
    timer = setTimeout(() => {
      commFn.searchOption(keyword, '/isrc', (res) => {
                      ...
                      >
                        <Col flex="auto">
                          <Form.Item
                            ...
                            label={isLabel}
                            key={`${isName}_isrc_id_${field.fieldKey}`}
                                  ...
                                  ? (
                                    isList[idx].map(d => (
                                      <Option
                                        key={d.isrc_id}
                                        label={d.song_name}
                                        songinfocode={`${d.singer} | ${d.isrc}`}
                                      >
                                        {`${d.song_name} (${d.singer} | ${d.isrc})`}
                                      </Option>
                                    ))
                                  )
                                  : ([])
