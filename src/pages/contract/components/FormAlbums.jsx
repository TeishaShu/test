                      ...
                      >
                        <Col flex="auto">
                          <Form.Item
                            ...
                            label={isLabel}
                            key={`${isName}_album_id_${field.fieldKey}`}
                          ...
                          >
                            <Select
                              ...
                              onFocus={() => {
                                ...
                                if (form.getFieldValue()[isName][idx] && form.getFieldValue()[isName][idx]['album_name_zh']) {
                                  searchOption(form.getFieldValue()[isName][idx]['album_name_zh'], idx);
                                }
                              }}
